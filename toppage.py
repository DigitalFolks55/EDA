...
st.text(
    ...
    It provides a structured approach to exploring datasets, enabling users to gain initial insights and identify potential patterns,
    anomalies and relationships within their data before moving on to complex analysis.
...
hist = {
    "Version": ["0.0.0"],
    "Date": ["2025-02-25"],
    "Description": ["Crated an application"],
}
